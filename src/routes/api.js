...
import GeneralController from "../modules/controllers/generalController.js";
import ProfileController from "../modules/controllers/profileController.js";
import ForumController from "../modules/controllers/forumController.js";
import UploadsController from "../modules/controllers/uploadsController.js";
import MessagesController from "../modules/controllers/messagesController.js";
...
router.get(
  "/user/threads",
  verifyAccessToken,
  GeneralController.getUserThreads
);
router.get(
  "/user/answers",
  verifyAccessToken,
  GeneralController.getUserAnswers
);
router.get("/user/bans", verifyAccessToken, GeneralController.getUserBans);
router.get(
  "/user/authHistory",
  verifyAccessToken,
  GeneralController.getAuthHistory
);
router.get(
  "/user/authHistory/search",
  verifyAccessToken,
  GeneralController.searchAuthHistory
);
...
router.post(
  "/report/create",
  verifyAccessToken,
  GeneralController.createReport
);
router.delete(
  "/reports/delete",
  verifyAccessToken,
  GeneralController.deleteReports
);
...
router.put(
  ...
  verifyAccessToken,
  ProfileController.uploadUserPicture
);
router.put(
...
router.delete(
  ...
  verifyAccessToken,
  ProfileController.deleteNotifications
);
...
router.put(
  "/thread/adminedit",
  verifyAccessToken,
  ForumController.adminEditThread
);
...
router.post(
  "/folder/create",
  verifyAccessToken,
  UploadsController.createFolder
);
router.delete(
  "/folder/delete",
  verifyAccessToken,
  UploadsController.deleteFolder
);
...
router.get(
  "/files/all/admin",
  verifyAccessToken,
  UploadsController.getAdminAllFiles
);
...
router.post(
  "/file/comment/create",
  verifyAccessToken,
  UploadsController.createComment
);
router.delete(
  "/file/comment/delete",
  verifyAccessToken,
  UploadsController.deleteComment
);
router.put(
  "/file/comment/like",
  verifyAccessToken,
  UploadsController.likeComment
);
