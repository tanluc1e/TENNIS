...
export const getBans = async (req, res, next) => {
  try {
    const { limit = 10, page = 1, sort } = req.query;
...
export const getBan = async (req, res, next) => {
  try {
...
export const getAuthHistory = async (req, res, next) => {
  try {
    const { userId, limit = 10, page = 1 } = req.query;
    const moder = req.payload.role >= 2;
...
export const searchAuthHistory = async (req, res, next) => {
  try {
...
export const deleteReports = async (req, res, next) => {
  try {
    const moder = req.payload.role >= 2;
